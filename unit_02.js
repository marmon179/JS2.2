...
let e3 = 3;
let f3 = "Hello";
document.querySelector(".out-6").textContent = e2 + f3;
...
function t8() {
    let val = document.querySelector(".out--1").value
    console.log(val)
}
...
function t9() {
    ...
    console.log(val)
    document.querySelector(".i-9").innerHTML = ""
}
...
function t10() {
    ...
    document.querySelector(".out-10").textContent = val * 10
}
...
function t11() {
    ...
    document.querySelector(".out-11").textContent = val + 10
}
...
function t12() {
    ...
    let family = document.querySelector(".i-12_2").value
    const out = document.querySelector(".out-12")
    out.textContent = `Hello ${name} ${family}`
}
...
function t13() {
    const val1 = +document.querySelector(".i-13_1").value
    const val2 = +document.querySelector(".i-13_2").value
    const out = document.querySelector(".out-13")
    out.textContent = val1 + val2
}
...
const sum = document.querySelector(".i-14").value = "Hello"
...
function t16() {
    ...
    document.querySelector(".out-16").textContent = val1 + val2
}
...
function t18() {
    ...
    document.querySelector(".out-18").textContent = parseFloat(t)
}
...
function t19() {
    const val1 = parseInt(document.querySelector(".i-19-1").value)
    const val2 = parseInt(document.querySelector(".i-19-2").value)
    document.querySelector(".out-19").textContent = val1 + val2
}
